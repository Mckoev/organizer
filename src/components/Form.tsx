...
function Form() {
    ...
    const location: string | null = useAppSelector((state) => state.toolkitSliceWeatherForOneDay.location)
    const country: string | null = useAppSelector((state) => state.toolkitSliceWeatherForOneDay.country)
